...
StarRatings.propsType = {
	maxRatings: PropsType.number,
	color: PropsType.string,
	size: PropsType.number,
	className: PropsType.string,
	messages: PropsType.array,
	defaultRating: PropsType.number,
	onSetRating: PropsType.func,
};
